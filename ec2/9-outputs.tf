...
output "certificate_arn" {
  description = "Certificate arn of the self-signed Certificate uploaded in ACM"
...
output "target_group_arn" {
  description = "ARNs of the target groups. Useful for passing to Auto Scaling group"
